...
class ContentCrew():
    ...
    def web_searcher(self) -> Agent:
        """Defines the agent responsible for performing web searches."""
        return Agent(
    ...
    def web_summarizer(self) -> Agent:
        """Defines the agent responsible for summarizing web search results."""
        return Agent(
    ...
    def web_searcher_task(self) -> Task:
        """Defines the task for the web searcher agent."""
        return Task(
    ...
    def summarization_task(self) -> Task:
        """Defines the task for the web summarizer agent."""
        return Task(
