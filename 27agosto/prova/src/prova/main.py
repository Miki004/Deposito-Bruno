...
from prova.crews.content_crew.content_crew import ContentCrew
from prova.crews.sum_crew.sum_crew import SumCrew
from prova.crews.rag_crew.rag_crew import RagCrew
...
class GuideCreatorFlow(Flow[GuideCreatorState]):
    ...
    def get_user_input(self):
        ...
        print("\n=== RAG AGENT  ===\n")
        # Get user input
        self.state.topic = input("User query:")
